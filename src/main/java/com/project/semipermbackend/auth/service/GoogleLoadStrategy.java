...
import com.project.semipermbackend.auth.entity.GoogleOAuth2User;
...
public class GoogleLoadStrategy extends SocialLoadStrategy {
    ...
    @Override
    protected GoogleOAuth2User sendRequestToSocialApi(HttpEntity request) {
    ...
    @Override
    protected GoogleOAuth2User makeOAuth2User(Map<String, Object> attributes) {
